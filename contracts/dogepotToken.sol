...
contract DogePot is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Innovation for protocol by DOGEPOT Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own DOGEPOT to claim reward');
